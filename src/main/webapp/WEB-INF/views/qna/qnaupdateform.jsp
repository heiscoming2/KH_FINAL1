...
<!-- 본문 시작 -->
    <div class="qna_insertwrap">
	  ...
	  <div style="height:80px;">
	    ...
	    <input type="button" value="취소" class="btn btn-primary" onclick="location.href='qnadetail.do?bd_no=${dto.bd_no }'" style="float:right;" >
	   </div>
    </form>
...
<!-- QNAINSERT 개별 JS -->
<script type="text/javascript" src="resources/js/qnaupdate.js?ver=1.1"></script>
