               ...
               <div class="card-body">                    
                   <div>
                       <div class="mb-3 row text-center">
                           ...
                           <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" value="${noteDto.n_sender}">
                           </div>
                       </div>
                       <div class="mb-3 row text-center">
                           <label class="col-sm-2 col-form-label">받은시간</label>
                           <div class="col-sm-10">
                       ...
                       <div class="mb-3 row text-center">
                           ...
                           <div class="col-sm-10">
                             <textarea readonly class="form-control-plaintext" style="height: 200px; resize: none;" value="${noteDto.n_content}"></textarea>
                           </div>
                       </div>  
