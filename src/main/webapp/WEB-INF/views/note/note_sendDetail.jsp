...
<div class="container mt-5 mb-5" style="max-width: 1000px;">
    ...
    <button class="btn btn-default" onclick="location.href='note_sendDelete.do?n_no=${noteDto.n_no}'">삭제</button>
               ...
               <div class="card-body">                    
                   <div>
                       <div class="mb-3 row text-center">
                           <label class="col-sm-2 col-form-label">받은 사람</label>
                           <div class="col-sm-10">
                             <input type="text" readonly class="form-control-plaintext" value="${noteDto.m_nickname}">
                           </div>
                       </div>
                       <div class="mb-3 row text-center">
                           <label class="col-sm-2 col-form-label">보낸 시간</label>
                           <div class="col-sm-10">
