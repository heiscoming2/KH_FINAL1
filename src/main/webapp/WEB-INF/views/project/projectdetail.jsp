        ...
        <tr>
          <td>
            ...
            <div class="profile_wrap">
              <!-- 프로필 이미지 영역 -->
              <img src="${projectDetailDto.m_img_path }${projectDetailDto.m_img }" alt="mdo" width="35" height="35" class="rounded-circle me-2 profile_img">
              <!-- 프로필 아이디 표시 영역 -->
              <span class="profile_id">
                <a class="d-flex align-items-center text-decoration-none dropdown-toggle" id="dropdownaUser"
                  data-bs-toggle="dropdown" aria-expanded="false">
                  ${projectDetailDto.m_nickname }
                </a>
              ...
              <span class="reg_date">
                <fmt:formatDate value="${projectDetailDto.bd_createddate }" pattern="yyyy-MM-dd HH:mm:ss"/> (작성)
                <c:if test="${projectDetailDto.bd_modifydate ne null }">
                	<fmt:formatDate value="${projectDetailDto.bd_modifydate }" pattern="yyyy-MM-dd HH:mm:ss"/> (수정)
				</c:if>
              </span>
            ...
            <!-- 글 번호 / 제목 영역 시작 -->
             <div style="margin: 10px 0px;">
              <span class="detail_no">${projectDetailDto.bd_no }</span> <!-- 글 번호 -->
              <br>
              <span class="detail_title">${projectDetailDto.bd_title }</span> <!-- 글 제목 -->
             </div>
            <!-- 글 번호 / 제목 영역 종료 --> 

             <br>
            <div style="float:right;"> <!-- 작성자에게만 보여질 버튼 -->
              <input type="button" value="수정" class="btn btn-primary" onclick="location.href='projectupdateform.do?bd_no=${projectDetailDto.bd_no}'">
            ...
            <div class="text-center">
				<div class="heart" onclick="likeclick()" style="margin:0 auto;">
					<span style="color:orange; font-size:12px;"><b>추천수 ${projectDetailDto.bd_recommandcount}</b></span>
				</div>
