...
CREATE TABLE PROJECT (
   ...
   BD_NO NUMBER,
   CONSTRAINT PROJECT_BDNO_FK FOREIGN KEY(BD_NO) REFERENCES BOARD(BD_NO),
   CONSTRAINT PROJECT_BDNO_PK PRIMARY KEY(BD_NO)
);
...
--개인회원 활동3 정지1
INSERT INTO IT_MEMBER VALUES( 1004,'user1','1234','회원일','010-22222-1111','user1@itpro.com','N','활동','Y','개인회원','N','profileimages/','testprofile.jpg',SYSDATE);--개인회원 활동
INSERT INTO IT_MEMBER VALUES( 1005,'user2','1234','회원이','010-22222-2222','user2@itpro.com','N','활동','Y','개인회원','N','profileimages/','testprofile.jpg',SYSDATE);--개인회원 활동
INSERT INTO IT_MEMBER VALUES( 1006,'user3','1234','회원삼','010-22222-3333','user3@itpro.com','N','활동','Y','개인회원','N','profileimages/','testprofile.jpg',SYSDATE);--개인회원 활동
INSERT INTO IT_MEMBER VALUES( 1007,'user4','1234','회원사','010-22222-4444','user4@itpro.com','N','정지','Y','개인회원','N','profileimages/','testprofile.jpg',SYSDATE);--개인회원 정지
...
--REPLY (댓글)
INSERT INTO REPLY VALUES (1,SYSDATE,SYSDATE,'ASDF','123.123.123.123',1001,1000);
