...
SELECT A.M_NO, A.M_NICKNAME, A.M_TYPE, A.M_GENDER, A.M_REGDATE, A.M_ACT, A.M_USED, A.M_AUTH, B.M_ADMIN_CERT
...
-- STUDY LIST
INSERT ALL
INTO BOARD VALUES(1563,'서울 강남구 자바 스터디 모집합니다.','자바 초보 스터디 입니다.',SYSDATE,NULL,0,'192.168.0.1',3,1000)
