...
import com.itpro.model.dto.Ex_kakaoPay.KakaoPayApprovalVO;
import com.itpro.model.dto.Ex_kakaoPay.KakaoPayReadyVO;
...
import lombok.extern.log4j.Log4j;
	...
	public class Ex_KakaoPay { 
		...
		private KakaoPayReadyVO kakaoPayReadyVO; RestTemplate restTemplate = new RestTemplate(); 
		
		
		public static HttpHeaders headers() { 
			// 서버로 요청할 Header 
			HttpHeaders headers = new HttpHeaders(); 
			headers.add("Authorization", "KakaoAK " + "c1011b15c30c998efa86e461b4aa0995"); 
