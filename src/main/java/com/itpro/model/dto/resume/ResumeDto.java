...
public class ResumeDto {
	...
	private String r_selfletter;
	private String r_portfolio;
	...
	public ResumeDto(int m_no, int r_no, String r_title, String r_selfletter, String r_portfolio, String r_img,
			String r_img_path, int ca_no, String ca_title, String ca_content, String ca_start_date, String ca_end_date,
			int ed_no, String ed_date, String ed_schoolName, String ed_graduation, String ed_major, String ed_school,
			int li_no, String li_title, String li_date, String li_organ) {
		super();
		this.m_no = m_no;
		this.r_no = r_no;
